...
class I2SB(pl.LightningModule):
    """
    A PyTorch Lightning module for I2SB model training.
    ...
    def __init__(
        self, unet_model: torch.nn.Module, diffusion: torch.nn.Module, lr: float = 1e-3
    ):
        super().__init__()
    ...
    def forward(self, lr_img: torch.Tensor) -> torch.Tensor:
        """Forward pass of the I2SB model.
        ...
        """
        return self.diffusion.sample(self.unet, lr_img)
    ...
    def validation_step(
        ...
        pred_x_0 = self.diffusion.sample(self.unet, lr_img)
