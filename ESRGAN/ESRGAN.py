...
class ESRGAN(pl.LightningModule):
    def __init__(
        ...
        """Initialize the ESRGAN (Enhanced Super-Resolution Generative Adversarial Networks) model.
    ...
    def generator_loss(
        ...
        hr_features = self.feature_extractor(hr_images).detach()
        content_loss = self.content_loss(sr_features, hr_features)
